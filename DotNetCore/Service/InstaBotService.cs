        ...
        public async Task ExecuteInstagram(string link, string user, string password, int qtd, IList<IList<object>> sheetValues)
        {
            ...
            switch (qtd)
            {
                case 2:
                    ...
                    {
                        pessoas.Add(new Pessoa() { User = Convert.ToString(nome[0]) });

                        if (pessoas.Count == 2)
                        {
                            _driver.FindElement(By.XPath(".//*[@id='react-root']/section/main/div/div/article/div[2]/section[3]/div/form")).Click();
                            var _pessoas = _driver.FindElement(By.XPath(".//*[@id='react-root']/section/main/div/div/article/div[2]/section[3]/div/form/textarea"));
                            _pessoas.SendKeys(pessoas.ElementAt(0).User + " " + pessoas.ElementAt(1).User);
                            _driver.FindElement(By.XPath(".//*[@id='react-root']/section/main/div/div/article/div[2]/section[3]/div/form/button")).Submit();
                            Thread.Sleep(60000);
                            pessoas.RemoveAt(1);
                            pessoas.RemoveAt(0);
                        }
                ...
                case 3:
                    foreach (var nome in sheetValues)
                    {
                        ...
                        if (pessoas.Count == 3)
                        {
                            _driver.FindElement(By.XPath(".//*[@id='react-root']/section/main/div/div/article/div[2]/section[3]/div/form")).Click();
                            var _pessoas = _driver.FindElement(By.XPath(".//*[@id='react-root']/section/main/div/div/article/div[2]/section[3]/div/form/textarea"));
                            _pessoas.SendKeys(pessoas.ElementAt(0).User + " " + pessoas.ElementAt(1).User + " " + pessoas.ElementAt(2).User);
                            _driver.FindElement(By.XPath(".//*[@id='react-root']/section/main/div/div/article/div[2]/section[3]/div/form/button")).Submit();
                            Thread.Sleep(60000);
                            pessoas.RemoveAt(2);
                            pessoas.RemoveAt(1);
                ...
                default:
                    foreach (var nome in sheetValues)
                    {
                        ...
                        _driver.FindElement(By.XPath("//*[@id=\"react-root\"]/section/main/div/div[1]/article/div[3]/section[3]/div")).Click();
